/**
 * 🎉 FESTIVAL THEME CONTROL CENTER
 * 
 * Toggle themes ON/OFF from here - only enable ONE theme at a time!
 * Set the one you want to 'true', and all others to 'false'
 * 
 * Example:
 * - For Christmas/New Year: Set winter to true, all others to false
 * - For Diwali: Set diwali to true, all others to false
 * - For regular days: Set all to false
 */
