...
export default function Hero() {
  return (
    <section className="relative w-full">
      <div className="absolute inset-0 bg-linear-to-r from-blue-600 via-cyan-500 to-emerald-400" />
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 md:px-8 py-20 text-center text-white">
