...
export default function SeriesTrailerCard({
  ...
  return (
    <div
      className={`relative bg-white shadow-md hover:shadow-lg transition-shadow rounded-lg border-t-4 ${color} p-6`}
    >
      {/* Coming Soon Badge */}
      ...
      {/* Tagline */}
      {tagline && (
        <p className="text-sm italic text-slate-500 mb-3">{tagline}</p>
      )}
